...
export const register = (server: McpServer, store: DocumentStore) => {
  server.registerTool(
    ...
    {
      description:
        "Undo the last mutation on a document. Returns whether an undo was performed and the resulting can_undo/can_redo state.",
  ...
  server.registerTool(
    ...
    {
      description:
        "Redo the last undone mutation on a document. Returns whether a redo was performed and the resulting can_undo/can_redo state.",
